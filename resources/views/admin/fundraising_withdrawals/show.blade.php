    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <h3 class="text-indigo-950 text-3xl font-bold mb-5">Permintaan Penarikan Dana</h3>
                ...
                <hr class="my-5">
                <h3 class="text-indigo-950 text-xl font-bold mb-5">Mengirim donasi ke:</h3>
                ...
                @if($fundraisingWithdrawal->has_sent)
                    <hr class="my-5">
                    <h3 class="text-indigo-950 text-xl font-bold mb-5">Sudah dikirim</h3>
