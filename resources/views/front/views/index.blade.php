...
@section('title', 'bagipanen.com - Ayo Makmurkan Mereka')
@section('content')
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-white overflow-x-hidden pb-[134px]">
        <div class="header flex flex-col bg-gradient-to-b from-[#3CBBDB] to-[#EAD380] rounded-b-[50px] overflow-hidden">
            <nav class="pt-5 px-3 flex justify-between items-center">
                <div class="flex items-center gap-[10px]">
                    ...
                    <div class="flex flex-col text-white">
                        ...
                        <p class="font-semibold text-sm">Yogyakarta, Indonesia</p>
                    </div>
                </div>
            ...
            <div class="w-full h-fit overflow-hidden -mt-[33px]">
                <img src="{{asset('assets/images/backgrounds/hero-background-real.png')}}" class="w-full h-full object-contain" alt="background">
            </div>
        </div>
        <div id="popular-fundrising" class="mt-8">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Proyek <br>Populer</h2>
        ...
        <div id="best-choices" class="mt-8 -mb-6">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Pilihan <br>BagiPanen</h2>
                <a href="" class="p-[6px_12px] rounded-full bg-[#E8E9EE] font-semibold text-sm">Lihat Semua</a>
            </div>
            <div class="main-carousel mt-[14px]">
                ...
                @empty
                    <p>Maaf, belum ada proyek yang dibuat</p>
                @endforelse
        ...
        <div id="latest-fundrising" class="mt-8">
            <div class="px-4 flex justify-between items-center">
                <h2 class="font-bold text-lg">Proyek <br>Terbaru</h2>
                <a href="" class="p-[6px_12px] rounded-full bg-[#E8E9EE] font-semibold text-sm">Lihat Semua</a>
            </div>
